...
async def test_get_candles_success(mock_client):
    """测试成功获取K线数据"""
    mock_client.market_api.get_candlesticks = Mock(return_value={
        'code': '0',
        'msg': '',
        'data': [
            ['1597026383085', '3.721', '3.743', '3.677', '3.708', '8422410', '22698348.04'],
            ['1597026383086', '3.730', '3.750', '3.680', '3.715', '8500000', '23000000.00']
        ]
    })
