...
class TestCryptoKlinesEndpoint:
    ...
    def test_get_klines_deduplicates_overlapping_data(self):
        ...
        cold_data = [
            {'symbol': 'BTCUSDT', 'timestamp': 1000, 'date': '2024-01-01T00:00:00+00:00', 'open': 100.0, 'high': 101.0, 'low': 99.0, 'close': 100.5, 'volume': 1000.0, 'bar': '1m'}
        ]
        hot_data = pd.DataFrame([
            {'timestamp': 1000, 'date': '2024-01-01T00:00:00+00:00', 'open': 100.0, 'high': 101.0, 'low': 99.0, 'close': 102.0, 'volume': 1000.0}  # Same timestamp, different close
        ])
