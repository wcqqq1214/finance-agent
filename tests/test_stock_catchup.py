...
async def test_catchup_with_gap(mock_metadata_gap, mock_stock_data):
    ...
    with patch('app.database.ohlc.get_metadata', return_value=mock_metadata_gap), \
         ...
         patch('app.config_manager.get_stock_catchup_config', return_value={"rate_limit_delay": 0.1}):
